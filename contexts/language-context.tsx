...
const translations = {
  en: {
    ...
    getYourKit: "Get Your Kit",
    testosteroneKit: "Testosterone Kit",
    stressEnergyKit: "Stress & Energy Kit",
    launchOffer: "Launch Offer",
    first50off: "First 50 buyers get 10% off",
  ...
  is: {
    ...
    getYourKit: "Pantaðu settið",
    testosteroneKit: "Testósterón sett",
    stressEnergyKit: "Streitu & Orku sett",
    launchOffer: "Ræsingartilboð",
    first50off: "Fyrstu 50 fá 10% afslátt",
